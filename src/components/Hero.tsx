...
export const Hero = () => {
    ...
    const [estaLoading, setEstaLoading] = useState<boolean>(true);
        ...
        <div>
            ...
            <div className="absolute left-0 top-0 z-40 size-full">
                <div className="mt-30 px-6 sm:px-10">
                    <h1 className="hero-heading text-white tracking-wide zentry pb-5">WELCOME TO</h1>

                    <p className="mb-5 md:mb-8 text-sm md:text-base text-white ">Solar System exploration <br/> Explore with us our solar system</p>
                    <Button 
                    id="more" 
                    title="Find More" 
