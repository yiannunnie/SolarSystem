...
<section className="min-h-screen bg-black text-white pt-20">
    ...
    <div className="flex flex-col md:flex-row md:gap-12">
        ...
        <div className="circularfont md:h-[120vh] md:overflow-y-auto no-scrollbar pt-10 md:pt-0">
            ...
            <h2 className="h2space">Nameshake</h2>
            <p>{nameshake}</p>

            <h2 className="h2space">Potential for Scientific Discovery</h2>
            {potential.map((p, i) => (
            <p className="pspace" key={i}>
                {p}
            </p>
            ...
            <h2 className="h2space">Orbit and Rotation</h2>
            {orbital.map((p, i) => (
            <p className="pspace" key={i}>
                {p}
            </p>
            ...
            <h2 className="h2space">Structure</h2>
            {structure.map((p, i) => (
            <p className="pspace" key={i}>
                {p}
            </p>
            ...
            <h2 className="h2space">Surface</h2>
            {surface.map((p, i) => (
            <p className="pspace" key={i}>
                {p}
            </p>
            ...
            <h2 className="h2space">Atmosphere</h2>
            <p>{atmosphere}</p>

            <h2 className="h2space">Magnetic Field</h2>
            <p>{magnethosphere}</p>
        </div>
        </div>

        <div className="md:w-1/2 min-h-screen pt-15 md:pt-0">
        <div className="flex flex-col items-center gap-15 md:order-1">
            {gallery.map((src, i) => (
            <div key={i} className="relative group w-full h-80">
                ...
                {imgdes1 && i === 0 && <div>{imgdes1}</div>}
                {imgdes2 && i === 1 && <div>{imgdes2}</div>}
                {imgdes3 && i === 2 && <div>{imgdes3}</div>}
                </div>
            </div>
            ))}
        </div>
